/*
(!) не работает в опере и хроме. в IE 11 не показывает окно вообще. Рабоатет в firefox и Edge. Почему?
(!) очистить куки про закрытие модального окна для копирования в консоль:
